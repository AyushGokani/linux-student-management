...
def main():
    ...
    academic_info_file = config.get('DEFAULT', 'academic_info_file', fallback='data/academic_info.txt')
    basic_info_file = config.get('DEFAULT', 'basic_info_file', fallback='data/basic_info.txt')
